...
const Signup = () => {
    ...
    return (
        <div className="w-screen h-screen font-[font] relative flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-violet-600/20 rounded-full blur-[120px] mix-blend-screen pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-fuchsia-600/10 rounded-full blur-[100px] mix-blend-screen pointer-events-none" />
